...
cufft::sptr cufft::make(const size_t fft_size,
                    const bool forward,
                    bool shift,
                    const size_t batch_size,
                    const memory_model_t mem_model)
{
    return gnuradio::make_block_sptr<cufft_impl>(
 ...
 */
cufft_impl::cufft_impl(const size_t fft_size,
                   const bool forward,
                   bool shift,
                   const size_t batch_size,
                   const memory_model_t mem_model)
...
int cufft_impl::work(int noutput_items,
